...
export const routes: Route[] = [
  ...
  // ========================================
  {
    id: "route-kashima-kobe",
    from: "port-kashima",
    to: "port-kobe",
    distance: 7,
    type: "branch",
    // 房総半島沖 → 伊豆諸島沖 → 遠州灘 → 紀伊水道 → 大阪湾
    waypoints: [
      { lat: 35.0, lng: 140.0 },  // 房総半島南端沖
      { lat: 34.3, lng: 139.0 },  // 伊豆大島沖
      { lat: 33.8, lng: 137.5 },  // 遠州灘
      { lat: 33.5, lng: 135.5 },  // 潮岬沖
      { lat: 34.2, lng: 135.0 },  // 紀伊水道
    ],
    mapWaypoints: [
      { x: 500, y: 530 },  // 房総半島沖
      { x: 450, y: 570 },  // 伊豆沖
  ...
  {
    id: "route-kashima-mizushima",
    from: "port-kashima",
    to: "port-mizushima",
    distance: 8,
    type: "branch",
    // 房総半島沖 → 伊豆諸島沖 → 遠州灘 → 紀伊水道 → 瀬戸内海
    waypoints: [
      { lat: 35.0, lng: 140.0 },  // 房総半島南端沖
      { lat: 34.3, lng: 139.0 },  // 伊豆大島沖
      { lat: 33.8, lng: 137.0 },  // 遠州灘
      { lat: 33.3, lng: 135.5 },  // 潮岬沖
      { lat: 34.0, lng: 134.5 },  // 紀伊水道→瀬戸内海
    ],
    mapWaypoints: [
      { x: 500, y: 530 },  // 房総半島沖
      { x: 450, y: 570 },  // 伊豆沖
