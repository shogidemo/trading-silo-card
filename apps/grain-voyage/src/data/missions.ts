...
export const missionTemplates: Omit<Mission, "id">[] = [
  // === 北海道発 → 本州・九州着 ===
  {
    ...
    description: "釧路のトウモロコシを鹿島港の飼料工場へ届けてください",
    grainId: "grain-corn",
    grainName: "トウモロコシ",
    amount: 50,
  ...
  {
    title: "衣浦から神戸へ小麦輸送",
    description: "衣浦港の小麦を神戸のパン工場へ",
    grainId: "grain-wheat",
    grainName: "小麦",
    amount: 40,
    fromPortId: "port-kinuura",
    fromPortName: "衣浦港",
    toPortId: "port-kobe",
    toPortName: "神戸港",
    reward: 1800,
  ...
  {
    title: "博多から志布志へ",
    description: "博多のトウモロコシを志布志の畜産農家へ",
    grainId: "grain-corn",
    grainName: "トウモロコシ",
    amount: 35,
  ...
  {
    title: "大量トウモロコシ輸送",
    description: "鹿島から志布志へ大量のトウモロコシを輸送",
    grainId: "grain-corn",
    grainName: "トウモロコシ",
    amount: 80,
    fromPortId: "port-kashima",
